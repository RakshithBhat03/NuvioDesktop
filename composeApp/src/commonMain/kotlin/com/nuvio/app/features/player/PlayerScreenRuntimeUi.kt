...
internal fun PlayerScreenRuntime.RenderPlayerRuntimeUi() {
    ...
    val playerControlsState = PlayerControlsState(
        ...
        themeTimelineBufferedColor = themeColors.playerTimelineBuffered.toCssColorString(),
        ...
        p2pActive = isP2pPlaybackActive,
        p2pDownloadSpeedBytes = p2pStats?.downloadSpeed ?: p2pConnecting?.downloadSpeed ?: 0L,
        p2pLoadedFraction = p2pStats?.totalProgress ?: 0f,
